...
template <typename T>
void print(const T&);   ///< Prints single val

/**
 * Prints all data vals in tree
 *
 * *********************************************************************************/
template <typename T>
...
template <typename T>
void print(const T& x) {    ///< Prints val passed as argument
...
/**
 * Prints size and height of binary tree and data val in each node in inorder
 *
